...
void Camera::init()
{
    ...
    updateAudios();
    connect(&m_audioDevices, &QMediaDevices::audioInputsChanged, this, &Camera::updateAudios);

    connect(audioDevicesGroup, &QActionGroup::triggered, this, &Camera::updateAudioDevice);
    ...
    updateCameras();
    connect(&m_videoDevices, &QMediaDevices::videoInputsChanged, this, &Camera::updateCameras);
...
void Camera::updateAudioDevice(QAction *action)
{
    setAudio(qvariant_cast<QAudioDevice>(action->data()));
}
